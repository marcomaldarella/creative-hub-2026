// Estratto da public/mockup-corso/v1.html: stessi contenuti, ma montati dentro il vero SiteChrome
...
export const css = `
  ...
  :host{display:block;background:var(--blue);color:var(--ink);
  ...
  .subnav{position:sticky;top:var(--header-h);z-index:40;background:var(--ink);
  ...
  .teacher .role{font-size:13px;font-family:var(--font-body),system-ui,sans-serif;margin-bottom:16px;}
  ...
  .siteHead{position:sticky;top:0;z-index:100;background:var(--blue);}
`;
